...
Original file is located at
    https://colab.research.google.com/drive/1v6i6IyNr2wk9f2M1Oq6O38c9NYntJavW

# Deep neural network definitions

This note book will provide all the function definitions that are required to buil and run a deep neural network with arbitray hidden layers
...
def relu_backward(dout, cache):
  ...
  #dx(x <= 0) = 0
  dx = np.heaviside(x, 0)#np.greater(dout, 0).astype(int)
  #############################################################################
  #                             END OF YOUR CODE                              #
  #############################################################################
  return dx
...
"""The activation function can be different for different layers. This is implemented in the following code"""
...
"""Compute the cost function for the iteration"""
...
"""The back propergation is implemented"""
